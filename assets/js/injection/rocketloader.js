!(function() {
  ...
  function a(t) {
    return (
      !(t.type && !E[t.type.trim()]) &&
      ((!A || !t.hasAttribute("nomodule")) && !(!A && "module" === t.type))
    );
  }
  function c(t, e) {
    return function(n) {
  ...
  function w(t) {
    ...
    r.insertPreloadHints(),
      j.runOnLoad(function() {
        r.run();
      });
  }
  function x(t) {
    var e = new N(t);
    j.simulateStateBeforeDeferScriptsActivation(),
      ...
      return (
        ...
        (t.prototype.write = function(t, e) {
          ...
          n && i(n) && n.hasAttribute("async")
            ? (r = e ? L : I).call.apply(r, [document].concat(t))
    ...
    if (t) {
      ...
      n
        ? (o(t),
          b(n),
          j.updateInlineHandlers(),
          n.bailout ? S(n.nonce) : (g(), w(n.nonce)))
        : e(
